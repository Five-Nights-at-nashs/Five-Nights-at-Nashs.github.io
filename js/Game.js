...
class Game {
    ...
    showTutorial(type = 'night1') {
        ...
        if (type === 'night2') {
            ...
            tutorialContent.innerHTML = `
                <h2>DEFEND YOURSELF AGAINST NICK</h2>
                <p>
                    NICK WILL TRY TO ATTACK YOU THROUGH THE VENTS IN CAM 1 AND CAM 2, SO IF YOU HEAR BANGING IN THE VENTS HEAD OVER TO THE CONTROL PANEL AND CLOSE THEM. 
                    ...
                    NICK CAN BE LURED WITH THE AUDIOS BUT YOUR MAIN PRIORITY WITH THE AUDIO LURES SHOULD BE NASH.
                </p>
            ...
            // Night 3 教程：霍金
            tutorialContent.innerHTML = `
                <h2>DEFEND YOURSELF AGAINST JAXSON</h2>
                <p>
                    JAXSON ALWAYS STAYS AT CAM 6 AND HE IS NOT AFFECTED BY THE AUDIO LURES. 
                    ELECTROCUTE JAXSON EVERY ONCE IN A WHILE TO PREVENT HIM FROM LEAVING CAM 6.
                </p>
                <button id="tutorial-got-it">GOT IT</button>
            `;
            // 重新绑定按钮事件
            ...
            // Night 1 教程：EP
            tutorialContent.innerHTML = `
                <h2>DEFEND YOURSELF AGAINST NASH</h2>
                <p>
                    NASH ALWAYS STARTS AT CAM 11. USE THE CAMERA'S AUDIO LURE TO KEEP NASH FAR AWAY FROM YOU. 
                    MAKE SURE THE CAMERA YOU'RE PLAYING THE SOUND IN IS NEXT TO THE CAMERA WHERE NASH IS. 
                    ...
                    NASH DOES NOT ATTACK THROUGH THE VENTS SO DON'T BOTHER CLOSING THEM FOR THIS NIGHT.
                </p>
                <button id="tutorial-got-it">GOT IT</button>
            `;
            // 重新绑定按钮事件
    ...
    showGoldenStephen() {
        ...
        goldenImg.src = `${this.assets.getBasePath()}assets/images/goldenstephen.png`;
    ...
    gameOverScreen(message, win = false) {
        ...
        if (win) {
            ...
            if (this.state.currentNight < this.state.maxNights) {
                ...
                subtitle.textContent = 'TO BE CONTINUED... (not really)';
